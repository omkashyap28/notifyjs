            ...
            <div className="flex flex-col justify-start gap-0.5">
              {docsLinks.map(({ title, url }) => (
                <Link
                  ...
                  className={`group relative z-1 overflow-hidden rounded-md px-3 py-1 font-sans text-[17px] font-normal tracking-tight capitalize transition-colors duration-150 hover:bg-neutral-200 dark:hover:bg-neutral-900 ${active === title ? "bg-neutral-200 dark:bg-neutral-900" : "bg-transparent"}`}
                  title={title}
                >
                  {title}
                </Link>
