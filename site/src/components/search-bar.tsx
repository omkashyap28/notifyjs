      ...
      <AnimatePresence>
        {visibility && (
          <motion.div
            ...
            className="fixed inset-0 top-20 z-9999 mx-auto h-fit w-[90%] max-w-xl rounded-md bg-neutral-50 px-4 py-2 shadow-md dark:bg-neutral-900"
          >
            <div className="flex items-center justify-between">
              <input
                ...
                className="text-foreground h-12 w-full pr-3 text-lg font-light tracking-wide outline-none selection:bg-blue-600!"
